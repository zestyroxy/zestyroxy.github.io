...
This one is a big one and might seem unacheivable, but you need to approach it a step at a time. You should start by gathering information through research and reading. The minimalists have many wonderful blog posts to help you http://www.theminimalists.com/start/[get started].
